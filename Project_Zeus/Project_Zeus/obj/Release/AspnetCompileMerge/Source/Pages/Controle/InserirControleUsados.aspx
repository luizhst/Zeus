                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" ReadOnly="true" MaxLength="50" ClientIDMode="Static" ID="txt_notafiscal" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" ReadOnly="true" MaxLength="50" ClientIDMode="Static" ID="txt_dta_notafiscal" CssClass="form-control"></asp:TextBox>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" rEQUIRED="TRUE" MaxLength="50" ClientIDMode="Static" ID="txt_cnpj_nota" CssClass="form-control"></asp:TextBox>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList AutoPostBack="false" runat="server" AppendDataBoundItems="true" CssClass="dropdown form-control" SelectionMode="sigle" MaxLength="50" ID="drp_produto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" AutoPostBack="true" required="true" MaxLength="50" ClientIDMode="Static" ID="txt_perc_sucata" CssClass="form-control" OnTextChanged="txt_perc_sucata_TextChanged"></asp:TextBox>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList AutoPostBack="false" ReadOnly="true" runat="server" AppendDataBoundItems="true" CssClass="dropdown form-control" SelectionMode="sigle" MaxLength="50" ID="drp_faturado_sucata">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList AutoPostBack="false" ReadOnly="true" runat="server" AppendDataBoundItems="true" CssClass="dropdown form-control" SelectionMode="sigle" MaxLength="50" ID="drp_faturado_fpq">
                                                    <asp:ListItem Value="Não" Text="Não" />
                                                    <asp:ListItem Value="Sim" Text="Sim" />
                                                </asp:DropDownList>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <a class="btn btn-default" href="NotasPendentesUsados.aspx">Voltar</a>
                                    </div>
                                </div>
