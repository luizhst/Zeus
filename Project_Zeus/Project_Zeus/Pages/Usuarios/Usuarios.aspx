                ...
                <div class="panel-wrapper collapse in" aria-expanded="false">
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            <asp:GridView ID="grid_usuarios" ClientIDMode="Static" AllowPaging="true" AllowSorting="true" PageSize="10" CssClass="tablesaw table-striped table-hover table-bordered table" AutoGenerateColumns="False" runat="server">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Nome" ItemStyle-Width="20%">
                                    ...
                                    <asp:TemplateField HeaderText="Data Nascimento" ItemStyle-Width="20%">
                                        <ItemTemplate><%#Eval("DtaNascimento") %> </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Ativo" ItemStyle-Width="15%">
