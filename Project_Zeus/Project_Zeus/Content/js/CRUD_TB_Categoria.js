function CadastrarCategoria(){
	...
	txt_des_nome = txt_des_nome.replace("'", "");	
	 ...
	 xmlreq.open("GET", "function/CRUD_TB_Categoria.php?txt_des_nome=" + txt_des_nome + "&acao=0", true);
					 ...
					 if (xmlreq.readyState == 4) {
						 ...
						 if (xmlreq.status == 200) {
							 ...
							 if (xmlreq.responseText == "1" || xmlreq.responseText == 1) {
									...
									SelectCategoria(0);
									result.innerHTML = "<b>Categoria Cadastrada</b>";
...
function SelectCategoria(paginaSelecionada){

var result = document.getElementById("tabela_categoria");
var result_combo = document.getElementById("SelectComboCategoria");
var retorno;
var tabela = "";
var combo = "";
var cont = 0;
...
xmlreq.open("GET", "function/CRUD_TB_Categoria.php?acao=1", true);
